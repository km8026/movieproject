...
-- 테이블 데이터 vgc.joinup:~3 rows (대략적) 내보내기
INSERT INTO `joinup` (`id`, `userEmail`, `userId`, `userPassword`, `userName`, `userCallname`) VALUES
	...
	(50, 'leeyelim98@naver.com', 'yerim', '21f34d62c4f7cb3c636096ae3108ae26f1139cfd9acc2f649ca8925b0db815e0', '이예림', '01025750674');
...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='영화예약';

-- 테이블 데이터 vgc.reservation:~1 rows (대략적) 내보내기
INSERT INTO `reservation` (`reservationId`, `location`, `hall`, `spot`, `date`, `starttime`, `endtime`, `userId`) VALUES
	(81, '부산', '1관', '서면점', '2024-06-19', '05:00:00', '07:00:00', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='티켓팅';

-- 테이블 데이터 vgc.ticketing:~2 rows (대략적) 내보내기
INSERT INTO `ticketing` (`ticketingId`, `seat`, `price`, `reservationId`, `movieId`) VALUES
	(61, 'B14, C14', 20000, NULL, NULL),
	(62, 'G10, G11', 20000, NULL, NULL);
